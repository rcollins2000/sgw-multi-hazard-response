...
- Models: risk (LightGBM + isotonic calibration + RF baseline), forecasting (Prophet with M2 tidal seasonality), anomaly (Prophet-residual), optimisation (OR-Tools VRP + Guided Local Search), graph (networkx BFS + Louvain), fairness auditing
