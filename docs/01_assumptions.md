...
- **Risk scoring:** supervised classification (calibrated with isotonic regression) blending forecast features, asset attributes, geospatial hazard layers, historical failures
